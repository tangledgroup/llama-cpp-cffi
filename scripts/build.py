...
def cuda_12_4_1_setup(*args, **kwargs):
    #
    # cuda env
    #
    cuda_file = 'cuda_12.4.1_550.54.15_linux.run'
    cuda_url = f'https://developer.download.nvidia.com/compute/cuda/12.4.1/local_installers/{cuda_file}'
    cuda_output_dir = os.path.abspath('./cuda-12.4.1')
    cuda_file_path = os.path.join(cuda_output_dir, cuda_file)
...
def build_linux_cuda_12_4_1(*args, **kwargs):
    ...
    # cuda env
    #
    cuda_output_dir = cuda_12_4_1_setup()
